      ...
      {visible && (
        ...
        >
          ...
          <div className="pointer-events-none absolute inset-0" aria-hidden="true">
            <motion.div
              className="absolute left-1/2 top-1/2 h-[min(900px,100vw,100vh)] w-[min(900px,100vw,100vh)] -translate-x-1/2 -translate-y-1/2 rounded-full"
              style={{
                background:
                  'radial-gradient(circle, rgba(201,162,39,.16) 0%, rgba(201,162,39,.055) 27%, transparent 68%)',
              }}
            ...
            <motion.div
              ...
              style={{
                backgroundImage:
                  'radial-gradient(circle at 50% 48%, rgba(255,224,142,.24) 0 1px, transparent 1.5px)',
          ...
          <div className="absolute left-1/2 top-[43%] h-[min(66vh,66dvh,560px)] w-[min(82vw,66vh,66dvh,560px)] -translate-x-1/2 -translate-y-1/2 sm:top-[42%]">
            <svg viewBox="0 0 500 500" className="h-full w-full overflow-visible" aria-hidden="true">
              ...
              <motion.g
                ...
                animate={{ opacity: [0, 1, 1, 0.18], scale: [0.82, 1, 1.02, 1], rotate: [-8, 0, 0, 4] }}
                transition={{ duration: 2.15, times: [0, 0.18, 0.72, 1], ease: 'easeInOut' }}
              >
                <motion.g
                  ...
                  {COIN_ANGLES.map((angle, index) => {
                    ...
                    return (
                      <motion.g
                        ...
                        transition={{ delay: index * 0.09, duration: 0.38 }}
                      >
              ...
              <motion.g>
                {[0, 1, 2, 3].map((i) => {
                  ...
                  return (
                    <motion.g
                      ...
                      transition={{ delay: 2.18 + i * 0.2, duration: 0.48, type: 'spring', stiffness: 260, damping: 18 }}
                    >
                ...
                <motion.ellipse
                  ...
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  transition={{ delay: 2.98, duration: 0.35 }}
                />
              </motion.g>

              {/* Growth arrow. */}
              <motion.path
                d="M 229 266 L 258 228 L 282 246 L 333 181"
                fill="none"
                stroke="#102846"
                strokeWidth="8"
                strokeLinecap="round"
                ...
                transition={{ delay: 2.82, duration: 0.75, ease: [0.22, 1, 0.36, 1] }}
              />
              <motion.path
                d="M 309 181 L 333 181 L 333 206"
                fill="none"
                stroke="#102846"
                strokeWidth="8"
                strokeLinecap="round"
                ...
                initial={{ pathLength: 0 }}
                animate={{ pathLength: 1 }}
                transition={{ delay: 3.26, duration: 0.32 }}
              />

              {/* Protective hand. */}
              <motion.path
                d="M 140 296 C 157 284 190 282 216 290 C 247 299 286 299 322 284 C 340 277 355 282 356 292 C 346 314 310 331 267 334 C 225 337 183 329 151 311 C 141 305 134 300 140 296 Z"
                fill="none"
                stroke="#102846"
                strokeWidth="5.5"
                strokeLinecap="round"
                ...
                transition={{ delay: 3.58, duration: 0.9, ease: 'easeInOut' }}
              />
              <motion.path
                d="M 159 300 C 178 296 201 297 221 304"
                fill="none"
                stroke="#102846"
                strokeWidth="3"
                strokeLinecap="round"
                initial={{ pathLength: 0 }}
                animate={{ pathLength: 1 }}
                transition={{ delay: 3.94, duration: 0.45 }}
              />
              ...
              <motion.circle
                ...
                initial={{ pathLength: 0, opacity: 0 }}
                animate={{ pathLength: 1, opacity: 1 }}
                transition={{ delay: 4.02, duration: 0.92, ease: [0.65, 0, 0.35, 1] }}
              />
              <motion.text
                x="250"
                y="124"
                ...
                transition={{ delay: 4.55, duration: 0.55, ease: 'easeOut' }}
              >
                FUND CARE
              </motion.text>
              <motion.text
                ...
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ delay: 4.96, duration: 0.75 }}
              >
              ...
              <motion.circle
                ...
                transition={{ delay: 5.55, duration: 1.1, times: [0, 0.42, 1] }}
              />
            </svg>
          </div>
          ...
          <div className="absolute inset-x-0 bottom-0 z-20 flex items-end justify-between px-5 pb-[max(20px,env(safe-area-inset-bottom))] sm:px-7">
            <button
              type="button"
              data-intro-control
              className="rounded-full border border-white/15 bg-white/5 px-3 py-2 text-xs tracking-wide text-white/55 backdrop-blur-md transition hover:bg-white/10 hover:text-white/85"
              onClick={closeIntro}
            >
              Skip intro
            </button>
            ...
            <button
              type="button"
              data-intro-control
              className="rounded-full border border-white/15 bg-white/5 px-3 py-2 text-xs text-[#f3e9c7]/80 backdrop-blur-md transition hover:bg-white/10 hover:text-white"
              onClick={() => {
                if (soundOn) {
                  setSoundOn(false);
                  return;
